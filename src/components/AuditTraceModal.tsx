                ...
                {claim.hasReceipt === true ? (
                  <span className="text-emerald-700 flex items-center gap-1">
                    ...
                    {claim.receiptFileName && (
                      <span className="text-[10px] bg-emerald-50 px-1.5 py-0.5 rounded border border-emerald-200 text-emerald-800 font-mono">
                        {claim.receiptFileName}
                      </span>
                    )}
                  </span>
                ) : claim.hasReceipt === false ? (
                  <span className="text-rose-700">No (Missing)</span>
                ) : (
                  <span className="text-amber-700">Unspecified (Null)</span>
                )}
              </div>
            </div>
